...
router.post('/validate-character', validate(schemas.validateCharacter), gameController.validateCharacter);
...
router.post('/validate-daily-challenge', validate(schemas.validateCharacter), gameController.validateDailyChallenge);
